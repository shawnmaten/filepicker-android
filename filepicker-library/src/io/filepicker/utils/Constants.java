...
public class Constants {
    ...
    public final static ArrayList<Provider> PROVIDERS_LIST = new ArrayList<>(Arrays.asList(
            new Provider("Gallery",       "Gallery",      MIMETYPE_IMAGE ,    R.drawable.sheet_gallery_icon, false, "GALLERY"),
            new Provider("Camera",        "Camera",       MIMETYPE_IMAGE,     R.drawable.sheet_camera_icon, false, "CAMERA"),
            ...
            new Provider("Dropbox",       "Dropbox",      MIMETYPE_ALL,       R.drawable.sheet_dropbox_icon, true, "DROPBOX"),
            ...
            new Provider("Instagram",     "Instagram",    MIMETYPE_IMAGE,     R.drawable.sheet_instagram_icon, true, "INSTAGRAM"),
            ...
            new Provider("Google Drive",  "GoogleDrive",       MIMETYPE_ALL,       R.drawable.sheet_drive_icon, false, "GOOGLE_DRIVE"),
    ...
    public static final String PROVIDERS_VIEW = "providers";
}
